...
public class PaymentUseCase {
    ...
    public void handlePayment(OrderDto orderDto, List<OrderItemDTO> orderItemDTOList) {
        // 주문시 포인트 변경
        userPointService.orderUserPoint(orderDto.getUserId(), orderDto.getTotalPaymentAmount());
        // 주문시 상품정보 변경
